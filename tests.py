...
class ComputationTest(unittest.TestCase):
	...
	def testLexer(self):
		...
		"""
		self.assertEqual(self._session.createEquation("1").evaluate(), 1)
		self.assertEqual(self._session.createEquation("100").evaluate(), 100)
		self.assertEqual(self._session.createEquation("-1").evaluate(), -1)
		self.assertEqual(self._session.createEquation("-100").evaluate(), -100)
		self.assertEqual(self._session.createEquation("0.5").evaluate(), 0.5)
		self.assertEqual(self._session.createEquation("-0.5").evaluate(), -0.5)
		self.assertEqual(self._session.createEquation(".5").evaluate(), 0.5)
		self.assertEqual(self._session.createEquation("-.5").evaluate(), -0.5)
		
		self.assertEqual(self._session.createEquation("1 - (1)").evaluate(), 0)
		self.assertEqual(self._session.createEquation("-1 - (-1)").evaluate(), 0)
		self.assertEqual(self._session.createEquation("1-(-(-1))").evaluate(), 0)
		self.assertEqual(self._session.createEquation("-1-(-(-1))").evaluate(), -2)
		self.assertEqual(self._session.createEquation("1 - ---1").evaluate(), 2)
		self.assertEqual(self._session.createEquation("1 - --1").evaluate(), 0)
		
		self.assertEqual(self._session.createEquation("-1-(-(-1 + 1 + 1 * 5))").evaluate(), 4)
	...
	def testOperators(self):
		...
		"""
		self.assertEqual(self._session.createEquation("10 - 33").evaluate(), -23)
		self.assertEqual(self._session.createEquation("10 - -33").evaluate(), 43)
		self.assertEqual(self._session.createEquation("10 + --33").evaluate(), 43)
		self.assertEqual(self._session.createEquation("10 + 6").evaluate(), 16)
		self.assertEqual(self._session.createEquation("10 % 3").evaluate(), 10 % 3)
		self.assertEqual(self._session.createEquation("10/5").evaluate(), 2)
		self.assertEqual(self._session.createEquation("10/3").evaluate(), float(10) / 3)
		self.assertEqual(self._session.createEquation("10\\3").evaluate(), 10 // 3)
		self.assertEqual(self._session.createEquation("5 * 5").evaluate(), 25)
		self.assertEqual(self._session.createEquation("1 > 2").evaluate(), 2)
		self.assertEqual(self._session.createEquation("10^2").evaluate(), 100)
		self.assertEqual(self._session.createEquation("1 < 2").evaluate(), 1)
		self.assertEqual(self._session.createEquation("1 > 2").evaluate(), 2)
	...
	def testBuiltInVariables(self):
		...
		"""
		self.assertEqual(self._session.createEquation("e").evaluate(), math.e)
		self.assertEqual(self._session.createEquation("pi").evaluate(), math.pi)
	...
	def testBuiltInFunctions(self):
		...
		produce a correct value.
		"""
		self.assertEqual(self._session.createEquation("abs(-1)").evaluate(), abs(-1))
		self.assertEqual(self._session.createEquation("acos(-1)").evaluate(), math.acos(-1))
		self.assertEqual(self._session.createEquation("asin(-1)").evaluate(), math.asin(-1))
		self.assertEqual(self._session.createEquation("atan(-1)").evaluate(), math.atan(-1))
		self.assertEqual(self._session.createEquation("atan(-1, -1)").evaluate(), math.atan2(-1, -1))
		self.assertEqual(self._session.createEquation("ceil(0.1)").evaluate(), math.ceil(0.1))
		self.assertEqual(self._session.createEquation("cos(-1)").evaluate(), math.cos(-1))
		self.assertEqual(self._session.createEquation("degrees(-1)").evaluate(), math.degrees(-1))
		self.assertEqual(self._session.createEquation("e(1.46, 2)").evaluate(), 146)
		self.assertEqual(self._session.createEquation("fact(5)").evaluate(), 120)
		self.assertEqual(self._session.createEquation("floor(1.9)").evaluate(), math.floor(1.9))
		self.assertEqual(self._session.createEquation("ln(5)").evaluate(), math.log(5, math.e))
		self.assertEqual(self._session.createEquation("log(5)").evaluate(), math.log(5))
		self.assertEqual(self._session.createEquation("log(5, 2)").evaluate(), math.log(5, 2))
		self.assertEqual(self._session.createEquation("ncr(5, 2)").evaluate(), 10)
		self.assertEqual(self._session.createEquation("npr(5, 2)").evaluate(), 20)
		self.assertEqual(self._session.createEquation("radians(-1)").evaluate(), math.radians(-1))
		self.assertEqual(type(self._session.createEquation("random()").evaluate()), float)
		self.assertEqual(type(self._session.createEquation("random(1, 10)").evaluate()), float)
		self.assertEqual(type(self._session.createEquation("randomint(1, 6)").evaluate()), int)
		self.assertEqual(self._session.createEquation("sin(-1)").evaluate(), math.sin(-1))
		self.assertEqual(self._session.createEquation("sqrt(16)").evaluate(), 4)
		self.assertEqual(self._session.createEquation("sum(1, 5)").evaluate(), 15)
		self.assertEqual(self._session.createEquation("sum(1, 5, 2)").evaluate(), 9)
		self.assertEqual(self._session.createEquation("tan(-1)").evaluate(), math.tan(-1))
	...
	def testVariables(self):
		...
		self.assertEqual(variables['a'].evaluate(), 1)
		self.assertEqual(variables_full['a'].evaluate(), 1)
		self.assertEqual(variables['b'].evaluate(), 2)
		self.assertEqual(variables_full['b'].evaluate(), 2)
		self.assertEqual(variables['c'].evaluate(), 3)
		self.assertEqual(variables_full['c'].evaluate(), 3)
		self.assertEqual(variables['d'].evaluate(), 6)
		self.assertEqual(variables_full['d'].evaluate(), 6)
		self.assertEqual(variables['f'].evaluate(), 8)
	...
	def testFunctions(self):
		...
		values.
		"""
		self.assertEqual(self._session.createEquation("g(1)").evaluate(), 2)
		self.assertEqual(self._session_full.createEquation("g(1)").evaluate(), 2)
		self.assertEqual(self._session.createEquation("g(-3)").evaluate(), -6)
		self.assertEqual(self._session_full.createEquation("g(-3)").evaluate(), -6)
		self.assertEqual(self._session.createEquation("g(1, 3)").evaluate(), 4)
		self.assertEqual(self._session_full.createEquation("g(1, 3)").evaluate(), 4)
		self.assertEqual(self._session.createEquation("g(-3, -1)").evaluate(), -4)
		self.assertEqual(self._session_full.createEquation("g(-3, -1)").evaluate(), -4)
		self.assertEqual(self._session.createEquation("h()").evaluate(), 5)
		self.assertEqual(self._session_full.createEquation("h()").evaluate(), 5)
	...
	def testEquations(self):
		...
		self.assertEqual(equations[1][1], 110)
		self.assertEqual(equations_full[1][1], 110)
		self.assertEqual(equations[2][1], -6)
	...
	def testErrors(self):
		...
		except calc.ConsecutiveFactorError: pass
		...
		except calc.ConsecutiveOperatorError: pass
		...
		except calc.DivisionByZeroError: pass
		...
		except calc.NullSubexpressionError: pass
		...
		except calc.RecursionError: pass
		try:
		...
		except calc.UnexpectedCharacterError: pass
